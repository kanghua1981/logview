...
export default function MetricsPanel() {
  const { 
    metrics, addMetric, removeMetric, toggleMetric, updateMetricData, 
    ...
    <div className="flex-1 flex flex-col p-4 space-y-4 overflow-hidden bg-gray-900">
      ...
      <div className="flex-1 flex flex-col min-h-0 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {metrics.map(metric => (
            <div key={metric.id} className="bg-gray-800 p-4 rounded-lg border border-gray-700 space-y-3">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <code className="text-xs text-gray-400 block mt-1">{metric.regex}</code>
